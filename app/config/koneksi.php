...
define('DB_USER', 'root'); // Username untuk mengakses database (default: root di XAMPP)
define('DB_PASS', ''); // Password database (kosong karena default di XAMPP)
define('DB_NAME', 'gudang'); // Nama database yang digunakan dalam aplikasi
